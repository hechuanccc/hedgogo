            ...
            operationGuide: [{
                                ...
                                <li>
                                    ...
                                    <ol class="m-b-0 p-l" style="list-style-type: lower-roman;">
                                        ...
                                        <li class="m-b-xs">前台屏蔽禁用该网关商户
                                            <p>如该网关所有支付方式都出现异常，直接将此网关商户拉为测试层级使用为，待修复后再次设置会员等级。</p>
                                        </li>
                                    </ol>
                                </li>
                                <li>
                ...
                sub: [{
                    ...
                    sub: [{
                        ...
                        title: '通过 IP 批量禁用会员',
                        ref: 'batch_ban',
                        content: '如发现异常 IP 有大量会员登录，可在会员列表以或系统参数配置中禁用可疑账号。'
                    }]
                }, {
                    title: '代理商',
                    ref: 'agent',
                        ...
                        content: `
                            <ol class="m-b-0 p-l" style="list-style-type: upper-alpha;">
                                ...
                                <li class="m-b-sm">标准赔率
                                    <p class="m-t-sm">
                                        系统另外提供标准赔率的参考，是系统依照改游戏的特定玩法的中奖机率计算出的赔率，可供参考。
                                    </p>
                                </li>
                            </ol>
                        `
                        ...
                        content: `
                            <ol class="m-b-0 p-l" style="list-style-type: upper-alpha;">
                                ...
                                <li class="m-b-sm">其他彩种
                                    <p class="m-t-sm">
                                        若出现彩票官方未开奖，但是在 3期 以内官方有补开，则系统会自动补开，超过 <span class="text-danger">3</span> 期，则系统无法自动补开，需奖金改游戏官方网站以确认。
                                    </p>
                                </li>
                            </ol>
                        `
