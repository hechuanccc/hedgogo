            ...
            <div class="row b-b p-b m-b">
              <div class="col-md-5">
                ...
                <div class="form-group m-t-md">
                  ...
                  <div class="inline-form-control">
                    <commissionsetting :commissionsetting="agent.commission_settings" @myCommission="myCommission" :required="false"/>
                  </div>
                </div>
                ...
                <div class="form-group m-t-md">
                  ...
                  <div class="inline-form-control">
                    <level :level="agent.default_member_lv" @level-select="levelSelect" :req="false"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <bank :bank="agent.bank.bank" :req="bankFilled" @bank-select="bank"/>
                </div>
                <div class="form-group">
    ...
    methods: {
        ...
        onSubmit (e) {
            ...
            if (agent.id) {
                ...
                this.$http.put(api.agentapplication + agent.id + '/', agent).then(() => {
                    this.$router.push('/agent/applications/')
                }, error => {
                    this.errorMsg = error
                })
            } else {
                this.$http.post(api.agentapplication, agent).then(() => {
                    this.$router.push('/agent/applications/')
                }, error => {
                    this.errorMsg = error
                })
