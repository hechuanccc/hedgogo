            ...
            <div class="box-body">
                <form class="form m-a" v-on:submit.prevent="onSubmit">
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label class="label-width">{{$t('setting.payment_type')}}</label>
                            <div
                            ...
                            >
                                ...
                                >
                                    <template slot="option" slot-scope="props">
                                        {{ props.option.name }}<span v-if="props.option.platform < 2">-{{ props.option.platform === 0 ? $t('manage.pc') : $t('manage.mobile') }}</span>
                                    </template>
                                    <template
                                        slot="tag"
                                        slot-scope="props"
                        ...
                        <div class="form-group">
                            ...
                            <div class="inline-form-control">
                                <input type="text" class="form-control w-xxl" v-model="payee.certificate"  />
                            </div>
                        </div>
        ...
        methods: {
            ...
            onSubmit (e) {
                ...
                if (unfilled.length > 0) {
                    $.notify({
                        message: `${this.$t('common.please_select')} ${unfilled.map(v => this.$t(this.validateField[v])).join(', ')}`,
                        type: 'danger'
                    })
                    return
                }
