...
export default {
    nav: {
        ...
        remit_payee_detail: '转账充值帐号详情',
        remit_payee_add: '增加转账充值帐户',
        remit_payee_update: '更新转账充值帐号',
    ...
    action: {
        ...
        view_history_bet_record: ' 历史投注',
        view_todays_bet_record: ' 今日投注',
        ...
        view_remit_payees: '查看转账充值帐号',
        update_remit_payee: '更新',
        add_remit_payee: '增加转账充值账户',
        add_staff: '增加子帐号',
        add_promotion: '新增活动',
    ...
    level: {
        ...
        no_remit_offer: '未设置转账充值优惠',
        level_settings: '组设定',
        available_onlinepay_acct_lbl: '可使用的线上支付商户',
        available_remit_acct_lbl: '可使用的转账充值帐号',
