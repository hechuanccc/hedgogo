 ...
 */
export const updateSetting = (type, { id, data, params } = {}) =>
    axios({
        method: id ? 'put' : 'post',
 ...
 * @param {*} type - 'announcement', 'banner', 'promotion', 'websiteDescription', 'commission', 'memberLevel', and 'role'
 */
export const deleteSetting = (type, id) =>
 ...
 */
export const updateSystemParameter = ({ key, data } = {}) =>
 ...
 */
export const updateWebsite = (type, data) =>
